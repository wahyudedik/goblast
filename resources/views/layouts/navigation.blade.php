<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('message-logs.index')" :active="request()->routeIs('message-logs.*')">
                        {{ __('Message Logs') }}
                    </x-nav-link>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('message-logs.index')" :active="request()->routeIs('message-logs.*')">
                {{ __('Message Logs') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('api-tokens.index')" :active="request()->routeIs('api-tokens.*')">
                {{ __('API Tokens') }}
            </x-responsive-nav-link>
