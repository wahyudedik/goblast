        ...
        <form action="{{ route('contacts.store') }}" method="POST" class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="group" id="group" value="{{ old('group') }}"
                        placeholder="Pelanggan, VIP, Karyawan" list="group-list"
                        class="w-full px-4 py-2.5 border border-gray-300 rounded-lg shadow-sm focus:border-green-500 focus:ring-2 focus:ring-green-500/20 transition-colors">
            ...
            <div>
                ...
                <textarea name="notes" id="notes" rows="3" placeholder="Catatan tambahan..."
                    class="w-full px-4 py-2.5 border border-gray-300 rounded-lg shadow-sm focus:border-green-500 focus:ring-2 focus:ring-green-500/20 transition-colors text-sm">{{ old('notes') }}</textarea>
            </div>
