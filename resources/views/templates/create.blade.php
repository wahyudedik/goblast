...
@section('page-title', 'Buat Template')
...
@section('content')
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h2 class="text-2xl font-bold text-gray-900">Buat Template Baru</h2>
                <p class="mt-1 text-sm text-gray-600">
                    Buat template pesan dengan variabel dinamis untuk personalisasi
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        <form action="{{ route('templates.store') }}" method="POST" class="p-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <textarea name="content" id="content" rows="8" required
                    ...
                    class="w-full px-4 py-3 border rounded-lg shadow-sm focus:border-green-500 focus:ring-2 focus:ring-green-500/20 transition-colors font-mono text-sm @error('content') border-red-500 @else border-gray-300 @enderror">{{ old('content') }}</textarea>
